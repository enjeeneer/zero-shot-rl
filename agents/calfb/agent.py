...
class CalFB(FB):
    """
    Calibrated Conservative Forward-Backward Agent. Can be
    ...
    def update(self, batch: Batch, step: int) -> Dict[str, float]:
        """
        Calls FB.update and does soft update of forward_mu_target.
        """
    ...
    def update_fb(
        ...
        Loss contains four components:
            ...
            3. Calibrated conservative loss: penalises out-of-distribution actions
            4. Forward-backward loss for exploration policy
        Args:
    ...
    def _measure_conservative_penalty(
        ...
        """
        Calculates the calibrated measure conservative penalty.
        Args:
            observations: observation tensor of shape [batch_size, observation_length]
            ...
            Fmu: forward embedding for exploration policy
    ...
    def _value_conservative_penalty(
        ...
        """
        Calculates the calibrated value conservative penalty.
        Args:
            observations: observation tensor of shape [batch_size, observation_length]
            next_observations: next observation tensor of shape
                                                     [batch_size, observation_length]
